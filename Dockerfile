...
RUN curl -LsS https://symfony.com/installer -o /usr/local/bin/symfony; chmod a+x /usr/local/bin/symfony; rm -rdf /dwl/default/var/www/html; symfony new /dwl/default/var/www/symfony 2.8; cp -rdf /dwl/default/var/www/symfony /dwl/default/var/www/html
